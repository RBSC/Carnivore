...
PRESENT_S:
	db	"Verify for Flesh ROM cartridge",13,10
	db	"Carnivore on absolute address",13,10,10,"$"

INFO_S:	db	"Usage: ABSVRF <filename.ext> <hexaddress> [<slot>]",13,10,10
	db	"       for example:",13,10
	db	"       ABSVRF SYSCSCC.ROM 00000 01",13,10, "$"
...
StPrg_S:
	db	"Start verify Flash ?$"
PRG_OK_S:
	db	"Verify finish",13,10,"$"
PRG_ER_S:
	db	"Verify stop on ERROR!",13,10,"$"
FR_ER_S:
