...
FindcrI_S:
	db	13,10,"Press Enter for the found slot or enter new slot number - $"
DESCR:	db	"CSCCFRC"
USEDOS2_S:
	db	"*** Please use DOS2! *** "
CRLF_S:	db	13,10,"$"
...
NR_L_S: db	"Press Enter to confirm or type a new name of directory entry:",13,10,"$"
